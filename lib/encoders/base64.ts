...
const encodeBase64 = (text: string, urlSafe = false): string => {
...
const decodeBase64 = (encoded: string, urlSafe = false): DecodeResult => {
...
const encodeBase64FromBytes = (bytes: Uint8Array, urlSafe = false): string => {
...
const wrapBase64Lines = (base64: string, lineLength = 76): string => {
...
export { encodeBase64, decodeBase64, encodeBase64FromBytes, wrapBase64Lines };
